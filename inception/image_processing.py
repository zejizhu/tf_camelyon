...
def parse_example_proto(example_serialized):
  ...
  return features['image/encoded'], label, bbox, features['image/class/text'],filename
...
def batch_inputs(dataset, batch_size, train, num_preprocess_threads=None,
  ...
  with tf.name_scope('batch_processing'):
    ...
    images, label_index_batch,filename_index_batch= tf.train.batch_join(
        images_and_labels,
    ...
    #print(filename_index_batch)
    return images, tf.reshape(label_index_batch, [batch_size]),tf.reshape(filename_index_batch, [batch_size])
