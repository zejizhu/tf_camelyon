...
def inference_endpoint(images, num_classes, for_training=False, restore_logits=True,
              scope=None):
  """Build Inception v3 model architecture.
  ...
  #return logits, auxiliary_logits
  #print("inference shape :%s "%(str(logits[0].shape)))
  return endpoints
...
def loss(logits, labels, batch_size=None):
  ...
  #print("logits[0] :%s "%(str(logits[0].shape)))
